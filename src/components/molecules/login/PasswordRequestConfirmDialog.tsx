...
const PasswordRequestConfirmDialog: FC<PasswordRequestConfirmDialogProps> = (
  props
) => {
  const { open, setOpen, id, onConfirm } = props;
  return (
    <Dialog
      open={open}
    ...
    >
      ...
      <DialogActions>
        <Button onClick={() => setOpen(false)}>キャンセルする</Button>
